...
public class EditDeviceActivity extends AppCompatActivity {
    ...
    private void initialize(Integer position) {
        this.device = Constant.getDevices(position);
    ...
    public void save(View view) {
        try {
            if (isEdit) {
                Constant.changeDevice(device, new Device(zonePopup.getText().toString(), name.getText().toString(),
                ...
                Constant.addDevice(new Device(zonePopup.getText().toString(), name.getText().toString(),
                        typePopup.getText().toString(), Integer.valueOf(delay.getText().toString()), Boolean.valueOf(notifySwitch.isChecked()),
                        Constant.getImageOnIcon(), Constant.getImageOffIcon(), getStringCode()));
            }
